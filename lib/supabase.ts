...
const mockFeatures: Record<string, Record<string, boolean>> = {
  'c1111111-1111-1111-1111-111111111111': { // Apex Fitness (PREMIUM)
  ...
  'c2222222-2222-2222-2222-222222222222': { // Iron Gym (BASIC)
    MEMBER_MANAGEMENT: true,
    ATTENDANCE_CHECKIN: true,
    ONLINE_PAYMENTS: true,
  ...
  'c3333333-3333-3333-3333-333333333333': { // Pulse Fitness (FREE)
    MEMBER_MANAGEMENT: true,
  ...
  'c4444444-4444-4444-4444-444444444444': { // Titan Health (PREMIUM)
    MEMBER_MANAGEMENT: true,
    ATTENDANCE_CHECKIN: true,
    ONLINE_PAYMENTS: true,
    SMS_WHATSAPP_NOTIFICATIONS: true,
